...
def main():
    ...
    parser.add_argument('-p', '--points', action='store_true', help='Legger til poengberegning for karusellløp')
    ...
    parser.add_argument('-po', '--poengo', action='store_true', help='PoengO, poeng og postkoder må settes i config_poengo.py')

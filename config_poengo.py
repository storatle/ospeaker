...
#['103', '130', '108', '73', '123', '133', '105', '110', '112', '106', '131', '113', '70', '72', '101', '100']
def bonus_track(): # Sprintstrekk og klatrestrekk må være med på listen her fordi det kan være forskjellige sprint og klatring
    track_1 = [['103', '130',100],['108', '73',100],['67','110',100],['114','101',100],['122','113',100]]
    track_2 = [['103', '130',100],['108', '73',100],['122','123',100],['103','106',100],['120','103',100]]
    return {
            'N': track_1,
            'DH 10': track_1,
            'DH 11-12': track_1, 
...
def data():
    return {
            ...
            'climb_track': ['103','130'], # sett til [] hvis ikke klatrestrekk
            'sprint_track': ['108','73'] # sett til klatrestrekk
            }
